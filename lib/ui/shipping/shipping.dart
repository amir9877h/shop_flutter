...
import 'package:shop_flutter/ui/payment_webview.dart';
...
class _ShippingScreenState extends State<ShippingScreen> {
  final TextEditingController firstNameController =
      TextEditingController(text: 'تست 01');

  final TextEditingController lastNameController =
      TextEditingController(text: 'تستی');

  final TextEditingController phoneNumberController =
      TextEditingController(text: '09000000000');

  final TextEditingController postalCodeController =
      TextEditingController(text: '1234567890');

  final TextEditingController addressController =
      TextEditingController(text: 'ایران تهران تهران تهران تهران تهران تهران');
